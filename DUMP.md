...
[x] getting this error in the console: react-dom_client.js?v=ceb213f8:20103 Download the React DevTools for a better development experience: https://react.dev/link/react-devtools
App.jsx:153 Uncaught ReferenceError: Cannot access 'toggleRecording' before initialization
    at App (App.jsx:153:31)
    at Object.react_stack_bottom_frame (react-dom_client.js?v=ceb213f8:18509:20)
    at renderWithHooks (react-dom_client.js?v=ceb213f8:5654:24)
    at updateFunctionComponent (react-dom_client.js?v=ceb213f8:7475:21)
    at beginWork (react-dom_client.js?v=ceb213f8:8525:20)
    at runWithFiberInDEV (react-dom_client.js?v=ceb213f8:997:72)
    at performUnitOfWork (react-dom_client.js?v=ceb213f8:12561:98)
    at workLoopSync (react-dom_client.js?v=ceb213f8:12424:43)
    at renderRootSync (react-dom_client.js?v=ceb213f8:12408:13)
    at performWorkOnRoot (react-dom_client.js?v=ceb213f8:11827:37)
react-dom_client.js?v=ceb213f8:6966 An error occurred in the <App> component.

Consider adding an error boundary to your tree to customize error handling behavior.
Visit https://react.dev/link/error-boundaries to learn more about error boundaries.

defaultOnUncaughtError @ react-dom_client.js?v=ceb213f8:6966
chunk-BGLIGTFO.js?v=ceb213f8:23 Lit is in dev mode. Not recommended for production! See https://lit.dev/msg/dev-mode for more information.
issueWarning @ chunk-BGLIGTFO.js?v=ceb213f8:23
api.web3modal.org/appkit/v1/config?projectId=ribbon-puddle-v3&st=appkit&sv=html-core-1.7.8:1  Failed to load resource: the server responded with a status of 403 ()
core-NBHA5TBC.js?v=ceb213f8:9690 [Reown Config] Failed to fetch remote project configuration. Using local/default values. Error: HTTP status code: 403
    at fetchData (chunk-CNDEWYRG.js?v=ceb213f8:2947:17)
    at async FetchUtil.get (chunk-CNDEWYRG.js?v=ceb213f8:2961:22)
    at async Object.fetchProjectConfig (chunk-CNDEWYRG.js?v=ceb213f8:6012:22)
    at async Object.fetchRemoteFeatures (core-NBHA5TBC.js?v=ceb213f8:9687:26)
    at async AppKit.initialize (core-NBHA5TBC.js?v=ceb213f8:9885:27)
fetchRemoteFeatures @ core-NBHA5TBC.js?v=ceb213f8:9690
...
[x] getting this console error: config.js:7 Uncaught ReferenceError: process is not defined
    at config.js:7:34
[x] presently the puddle just looks like a circle.  it needs to resemble a puddle much more.  see this sketch as a rough reference: ![alt text](signal-2026-03-27-171153-1.jpeg).  here are oil spill puddles for reference: https://www.dreamstime.com/mesmerizing-unsettling-rainbow-colors-swirls-surface-muddy-puddle-beautiful-stark-reminder-environmental-image413859753, https://www.dreamstime.com/mesmerizing-unsettling-rainbow-colors-swirls-surface-muddy-puddle-beautiful-stark-reminder-environmental-image413859753, and here's some oil droplets that might be good reference for when smearing with goop control when it gets out of the puddle and onto the controls
[x] when user clicks record it should also engage the play button. presently the record mode doesn't seem to do anything
